...
async function handleGetTokenByPassword() {
      ...
      <el-collapse v-model="activeName" accordion>
        <el-collapse-item class="el-collapse-item" name="1">
          ...
          <el-scrollbar class="fitSide">
            ...
            <h4 style="text-align: left;margin: 0">Password</h4>
            <el-input v-model="password" placeholder="password"/>
            <el-button type="primary" @click="handleGetTokenByPassword" class="t-button">
              Get Token
            </el-button>
